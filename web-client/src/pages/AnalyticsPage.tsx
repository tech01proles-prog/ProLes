              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={monthlyTrend}>
                    ...
                    <Tooltip formatter={(v) => formatMoney(Math.round(Number(v ?? 0)), 'RUB')} />
                    <Legend />
